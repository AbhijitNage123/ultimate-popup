...
export default function LinkPreview({
  ...
  const {
    richData,
    isFetching
  } = useRichUrlData(maybeRemoteURL); // Rich data may be an empty object so test for that.
  ...
  return createElement("div", {
  ...
  }, richData !== null && richData !== void 0 && richData.icon ? createElement("img", {
    ...
    fillProps: value
  })), (hasRichData || isFetching) && createElement("div", {
