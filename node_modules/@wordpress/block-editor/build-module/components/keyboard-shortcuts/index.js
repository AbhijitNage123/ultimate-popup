...
function KeyboardShortcuts() {
  ...
  const {
    ...
    moveBlocksUp,
    moveBlocksDown
  } = useDispatch(blockEditorStore); // Moves selected block/blocks up

  useShortcut('core/block-editor/move-up', useCallback(event => {
  ...
  useShortcut('core/block-editor/move-down', useCallback(event => {
    event.preventDefault();
