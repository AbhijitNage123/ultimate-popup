...
export const withBlockControls = createHigherOrderComponent(BlockEdit => props => {
  ...
  return createElement(Fragment, null, shouldDisplayControls && createElement(Fragment, null, createElement(TypographyPanel, props), createElement(BorderPanel, props), createElement(ColorEdit, props), createElement(SpacingPanel, props)), createElement(BlockEdit, props));
}, 'withToolbarControls');
/**
