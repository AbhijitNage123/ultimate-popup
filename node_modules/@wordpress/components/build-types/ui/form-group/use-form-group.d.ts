 ...
 */
export function useFormGroup(props: import('../context').PolymorphicComponentProps<import('./types').FormGroupProps, 'div'>): {
    className: string;
    contentProps: {
    ...
    weight?: "-moz-initial" | "inherit" | "initial" | "revert" | "unset" | "normal" | (number & {}) | "bold" | "bolder" | "lighter" | 900 | 700 | 300 | 200 | 400 | 500 | 100 | 600 | 800 | undefined;
