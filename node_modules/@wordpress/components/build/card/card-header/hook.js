...
function useCardHeader(props) {
  ...
  const classes = (0, _element.useMemo)(() => (0, _css.cx)(styles.Header, styles.borderRadius, styles.borderColor, styles.cardPaddings[size], isBorderless && styles.borderless, isShady && styles.shady, // This classname is added for legacy compatibility reasons.
