...
function getBlockContentValidationResult(blockTypeOrName, attributes, originalBlockContent, logger = (0, _logger.createQueuedLogger)()) {
...
function isValidBlockContent(blockTypeOrName, attributes, originalBlockContent) {
  const {
    isValid
  } = getBlockContentValidationResult(blockTypeOrName, attributes, originalBlockContent, (0, _logger.createLogger)());
  return isValid;
}
